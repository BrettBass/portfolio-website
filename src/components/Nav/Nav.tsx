...
//         <a className="flex items-center flex-col"> {/* Use flex container with flex-col to center picture and name vertically */}
//           <img
...
//         </a>
//       </div>
//       <div className="flex-grow text-left"> {/* Add text-left class to align buttons text to the left */}
//         <ul className="font-medium p-4 md:p-0 mt-4">
//           {links.map((link: Link) => {
//             return (
//               <li key={link.href} className="mb-2">
//                 <button
//                   type="button" // Use button element
//                   onClick={() => (window.location.href = link.href)}
//                   className="inline-flex items-left p-3 overflow-hidden text-2xl font-medium text-gray-900 rounded-lg group bg-transparent group-hover:bg-opacity-10 transition-all duration-200 group-hover:from-teal-300 group-hover:to-lime-300 dark:text-slate-50 dark:hover:text-gray-900 focus:ring-4 focus:outline-none focus:ring-lime-200 dark:focus:ring-lime-800 flex-grow w-full text-left hover:bg-gray-400" // Removed justify-between and added text-left and items-left
//                 >
//                   <span> {/* Removed items-center */}
//                     {link.label}
//                   </span>
//                 </button>
//               </li>
